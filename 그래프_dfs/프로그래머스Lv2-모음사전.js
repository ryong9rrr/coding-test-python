...
function solution(words) {
  return words
    ...
    .reduce(
      (total, word, i) =>
        total + [781, 156, 31, 6, 1][i] * ['A', 'E', 'I', 'O', 'U'].indexOf(word) + 1,
      0
    )
}
// 정확성  테스트
...
// 테스트 16 〉	통과 (0.07ms, 29.8MB)
// 테스트 17 〉	통과 (0.06ms, 30MB)
// 테스트 18 〉	통과 (0.06ms, 29.9MB)
// 테스트 19 〉	통과 (0.06ms, 30.1MB)
// 테스트 20 〉	통과 (0.06ms, 30.2MB)
// 테스트 21 〉	통과 (0.09ms, 30.1MB)
// 테스트 22 〉	통과 (0.06ms, 30MB)
// 테스트 23 〉	통과 (0.06ms, 30.1MB)
// 테스트 24 〉	통과 (0.16ms, 30MB)
// 테스트 25 〉	통과 (0.08ms, 30.2MB)
// 테스트 26 〉	통과 (0.06ms, 30.3MB)
// 테스트 27 〉	통과 (0.06ms, 30.2MB)
// 테스트 28 〉	통과 (0.10ms, 30MB)
// 테스트 29 〉	통과 (0.06ms, 30MB)
// 테스트 30 〉	통과 (0.05ms, 29.8MB)
// 테스트 31 〉	통과 (0.05ms, 30.1MB)
// 테스트 32 〉	통과 (0.06ms, 30.1MB)
// 테스트 33 〉	통과 (0.13ms, 29.9MB)
// 테스트 34 〉	통과 (0.09ms, 29.9MB)
// 테스트 35 〉	통과 (0.07ms, 30MB)
// 테스트 36 〉	통과 (0.05ms, 30.1MB)
// 테스트 37 〉	통과 (0.09ms, 29.8MB)
// 테스트 38 〉	통과 (0.08ms, 30MB)
// 테스트 39 〉	통과 (0.17ms, 30MB)
// 테스트 40 〉	통과 (0.06ms, 30MB)
